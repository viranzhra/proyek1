...
<body class="d-flex flex-column h-100">
  <main class="flex-shrink-0" style="background-color: #b3dbed;
    height: 650px;">
      ...
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <a href="../../../proyek1/dasboard klien/dasboard.php" class="breadcrumb-item" aria-current="page" style="    margin-left: 500px;
        ...
        <div class="card-body p-4">
          <div class="table-responsive">
            <table id="tabel-antrian" class="table table-bordered table-striped table-hover" width="100%">
              <thead style="background-color: #bdd8e5;">
                <tr>
                  <th style="
                  width: 850.4px;
                  font-weight: bold;
                  font-size: 20px;">Nomor Antrian</th>
                  <th>Status</th>
                  <th style="font-weight: bold;
                  font-size: 20px;">Panggil</th>
                </tr>
              </thead>
            </table>
          </div>
  ...
  <!-- Footer -->
  <footer class="footer mt-auto py-4" style="background-color: #b3dbed;">
    <div class="container">
      <hr class="my-4">
      </div>
    </div>
        ...
        "columns": [{
          ...
          },
          {
            ...
            "render": function(data, type, row) {
                ...
                var statusText = status === "1" ? "Sudah" : "Belum";
                return statusText;
