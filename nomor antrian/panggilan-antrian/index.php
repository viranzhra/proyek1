...
<body class="d-flex flex-column h-100" style="background-color: #B3E5FC;">
      ...
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <a href="../../../proyek1/dasboard.php" class="breadcrumb-item" aria-current="page" style="    margin-left: 500px;
        ...
        <div class="card-body p-4">
          <div class="table-responsive">
            <table id="tabel-antrian" class="table table-bordered table-striped table-hover" width="100%">
              <thead style=" border-color: #9ea9c3 !important;
                font-weight: bold;
                font-size: 20px;
