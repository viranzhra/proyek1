...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="gnti_password.php" data-toggle="collapse" data-target="#collapsePages"
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="layanan" style="background-color: #33b4ed; padding: 10px; width: 405px; border-radius: 8px; color: white; font-size: 25px; display: flex; align-items: center;">
                        <img src="../proyek1/images/icon nifas.png" class="img2">
                    ...
                    <div class="rectangle">
                        ...
                        <div class="content">
                            <p>
                            Pemeriksaan yang dilakukan dimulai dari wawancara kondisi ibu nifas secara umum, mengukur tekanan darah, suhu tubuh, 
                            pernapasan, dan nadi, memeriksa lokhia dan perdarahan, kondisi jalan lahir dan tanda infeksi, payudara, kontraksi rahim, 
                            memberikan Vitamin A, konseling, pelayanan kontrasepsi dan pemberian nasihat.
                            </p>
                            <img clas="img3" src="../proyek1/images/ibu nifas.png">
                        </div>
                    </div>
                    <br><br>
