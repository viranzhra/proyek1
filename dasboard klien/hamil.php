...
if(isset($_POST['daftar'])) {
    ...
    $sql = "INSERT INTO ibu_hamil VALUES('','$tanggal_daftar', '$nama','$tanggal_lahir','-','-','-','-','-','-','-','-','-','$alamat','$no_hp')";
...
<body>
    <div class="v259_40">
        <div class="v259_41">
            <div class="v259_42">
                <div class="v259_43"><span class="v259_44">Pendaftaran Pemeriksaan Ibu Hamil</span></div>
                <div class="v259_45">
                <form method="POST" action="hamil.php" id="form-pendaftaran">
            ...
            <a name="kembali" href="pm_hamil.php">Kembali</a>
        </div>
    </div>
