            ...
            <div id="content">
                ...
                <?php
                            ...
                            if ($updateResult) {
                                ...
                                echo '<script>
                                    Swal.fire({
                                        ...
                                        window.location.href = "gnti_password.php";
                                    });
                                </script>';
                            } else {
                    ...
                    <div class="container" style=" width: 400px;
                                ...
                                border-radius: 4px;
                                margin-top: 80px;">
                        <form style="margin-top: 20px;" method="POST" action="gnti_password.php">
                            ...
                            <input type="text" name="username" required style="padding: 8px;
                                ...
                                border-radius: 4px;
                                width: 100%;
                                box-sizing: border-box;" placeholder="Masukkan username"><br><br>
