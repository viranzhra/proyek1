            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="layanan" style="background-color: #33b4ed; padding: 10px; width: 405px; border-radius: 8px; color: white; font-size: 25px; display: flex; align-items: center;">
                        <img src="../proyek1/images/icon imunisasi.png" class="img2">
                        <b>Pemeriksaan Imunisasi</b>
                    </div>
                    <br>
                    ...
                    <div class="rectangle">
                        ...
                        <div class="content">
                            ...
                            membantu membentuk kekebalan tubuh atau imunitas terhadap infeksi sejumlah penyakit menular. Vaksin berasal dari kuman yang dilemahkan 
                            atau dimatikan.
                            </p>
                            <img clas="img3" src="../proyek1/images/imunisasi.png">
                        </div>
                    </div>
                    <br><br>
