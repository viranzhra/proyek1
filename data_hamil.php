            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <a style="margin-left: auto;" href="../../proyek1/tambah_data/tambah_hamil.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Tambah Data</a>
                    </div>
                        ...
                        <?php 
                            ...
                            if(isset($_GET['delete'])) {
                                ...
                                if(isset($_GET['confirm'])) {
                                    ...
                                    if($confirm === 'yes') {
                                        $sql = "DELETE FROM ibu_hamil WHERE nama = '$delete_nama'";
                                        if ($conn->query($sql) === TRUE) {
                                            ...
                                            echo '<script>
                                                Swal.fire({
                                                    ...
                                                    window.location.href = "data_hamil.php";
                                                });
                                            </script>';
                                        } else {
                                        ...
                                        header("Location: data_hamil.php");
                                        exit();
                                    }
                                }
                            }
                            ...
                            function konfirmasiHapus(nama) {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = "data_hamil.php?delete=" + nama + "&confirm=yes";
                                    } else {
                                        window.location.href = "data_hamil.php?delete=" + nama + "&confirm=no";
                                    }
                                });
                            }
                            </script>

                            <h6 style="width: 200px; position: absolute; top: 25px;" class="m-0 font-weight-bold text-primary">Data Keseluruhan</h6>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive" id="dataTable" style="width: 1350px;;" cellspacing="0"> 
                                    <style>
                                        .swal2-popup {
                                            font-size: 12px;
                                        }
                                    ...
                                    <thead>
                                            <tr>
                                                ...
                                                <th style="width: 105px;" class="thead-header">Tanggal datang</th>
                                                <th class="thead-header">Nama</th>
                                                <th style="width: 105px;" class="thead-header">Tanggal lahir</th>
                                                <th class="thead-header">BB</th>
                                                <th class="thead-header">TB</th>
                                                <th class="thead-header">Umur</th>
                                                <th class="thead-header">Letak Janin</th>
                                                <th class="thead-header">U.K(mg)</th>
                                                <th class="thead-header">Tinggi Fundus</th>
                                                <th class="thead-header">Keluhan</th>
                                                <th class="thead-header">Imunisasi</th>
                                                <th class="thead-header">Analisa</th>
                                                <th class="thead-header">Alamat</th>
                                                <th style="width: 0px;" class="thead-header">Telepon</th>
                                        ...
                                        // 2. query
                                        $data=mysqli_query($conn, "SELECT * FROM ibu_hamil");
                                        $no=1;
                                        while($hasil=mysqli_fetch_array($data)){
                                            ...
                                            echo "<td>".$hasil['Letak_Janin']."</td>";
                                            echo "<td>".$hasil['UK']."</td>";
                                            echo "<td>".$hasil['Tinggi_Fundus']."</td>";
                                            echo "<td>".$hasil['Keluhan']."</td>";
                                            echo "<td>".$hasil['Imunisasi']."</td>";
                                            echo "<td>".$hasil['Analisa']."</td>";
                                            echo "<td>".$hasil['alamat']."</td>";
                                            echo "<td>".$hasil['no_hp']."</td>";
                                            echo "<td><a style='background-color: #58d258; color: white; padding: 5px; border-radius: 3px;' href='../../proyek1/Edit_data/edit_hamil.php?edit=".$hasil['nama']."'>Edit</a>
