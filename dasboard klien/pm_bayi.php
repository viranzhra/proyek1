            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="layanan" style="background-color: #33b4ed; padding: 10px; width: 405px; border-radius: 8px; color: white; font-size: 25px; display: flex; align-items: center;">
                        <img src="../../proyek1/images/icon bayi.png" class="img2">
                        <b>Pemeriksaan bayi dan balita</b>
                    </div>
                    <br>
                    ...
                    <div class="rectangle">
                        ...
                        <div class="content">
                            <p>
                            Pemeriksaan fisik bayi baru lahir merupakan prosedur medis rutin yang penting dilakukan oleh 
                            setiap dokter atau bidan. Hal ini bertujuan untuk memastikan apakah bayi baru lahir dalam keadaan 
                            sehat atau memiliki kelainan tubuh maupun gangguan kesehatan.
                            </p>
                            <img clas="img3" src="../../proyek1/images/bayi.png">
                        </div>
                    </div>
                    <br><br>

                    <a name="kembali" href="dasboard.php">Kembali</a>
                    <a name="kembali" href="bayi.php" style="float: right;">Daftar</a>
            <!-- Footer -->
