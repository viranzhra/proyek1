                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Klinik Bidan Susan</span>
...
<div class="feature-icon-1 bg-success bg-gradient mb-4" style="display: inline-flex;
align-items: center;
...
position: absolute;
left: 200px;
font-size: 35px; top: 70px;">Panggilan Antrian</h3>
<p class="mb-4" style="text-align: center;
margin-left: 10px;
margin-top: 20px;">Data Untuk Melihat Keseluruhan Panggilan Antrian Sesuai Nomor Antrian Pasien.</p>
<a style="margin-top: 40px;
margin-left: 190px; background-color: #00aa9d !important" href="../../proyek1/nomor antrian/panggilan-antrian/data_klien.php" class="btn btn-success rounded-pill px-4 py-2">
